...
def parse_to_meaning_ful_text(input_phone_number, in_dict):
    ...
    me_t += "\n"
    me_t += "\n"
    me_t += "<i>MTProto Servers</i>"
    me_t += "\n"
    me_t += "<b>Produksi cofig</b>: "
    me_t += "<code>{}</code> <u>{}</u>".format(
        in_dict["MTProto Servers"]["production_configuration"]["IP"],
        in_dict[" MTProto Servers"]["production_configuration"]["DC"]
    )
    me_t += "\n"
    me_t += "<b>Tes Configuration</b>: "
    me_t += "<code>{}</code> <u>{}</u>".format(
        in_dict["MTProto Servers"]["test_configuration"]["IP"],
        in_dict["MTProto Servers"]["test_configuration"]["DC"]
    )
    me_t += "\n"
    me_t += "\n"
    me_t += "<i>Disclaimer</i>: "
